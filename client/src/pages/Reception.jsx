...
const Reception = () => {
  ...
  // Данные для RoomAllocation (пропсы)
  ...
  return (
    <div className="container reception-page">
      ...
      <div className="reception-grid">
        ...
        {/* Компонент 3: Стрелочная функция */}
        <ServiceManager
